<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/DashboardAdmin.Master" AutoEventWireup="true" CodeBehind="RegCode.aspx.cs" Inherits="BHSCMSApp.Dashboard.Tools.RegCode" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="col-md-8">
         <h3 class="headers">Modify Registration Code</h3> 
          <hr />
